...
function mySet() {
    ...
    // Set-up the collection to hold the set
    let collection = [];

    // has method - will check for the presence of an element and return true of false
    ...
    // intersecion method - will return the intersection of two sets as a new set
    ...
    // subset method - will test if a set is a subset of a different set
